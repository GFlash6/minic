...
<span style="color:red;font-weight:bold;">本产品为个人设计、手工制作开发实验板，不在3C强制认证产品目录，仅限电子爱好者个人学习、项目调试研发；
安全约定：因产品原生硬件缺陷（元器件虚焊故障），可协商质保；超出使用规范、私自改电源导致烧坏、起火等全部损失由使用人自行承担。
拍下使用即代表已完整阅读、知悉全部使用风险并自愿遵守使用规则。</span>

**最新文档：【腾讯文档】红绿灯 & MINIC 桌宠使用手册
https://docs.qq.com/doc/DS3BtWnJYa0dyZmJt**
